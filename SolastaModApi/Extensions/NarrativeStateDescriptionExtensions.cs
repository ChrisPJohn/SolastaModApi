...
namespace SolastaModApi.Extensions
{
    ...
    public static partial class NarrativeStateDescriptionExtensions
    {
        ...
        public static T SetAudioTarget<T>(this T entity, string value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetAutomaticExitLine<T>(this T entity, bool value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetClearPreviousRoles<T>(this T entity, bool value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetDialogHeadMovement<T>(this T entity, DialogHeadMovement value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetFadeDuration<T>(this T entity, float value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetFadeToBlack<T>(this T entity, bool value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetFixedDuration<T>(this T entity, float value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetNeedsAudioTarget<T>(this T entity, bool value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetNpcGroupIndex<T>(this T entity, int value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetNumberOfStepsToRewind<T>(this T entity, int value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetPlayerGroupIndex<T>(this T entity, int value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetSelectActorsWithoutARole<T>(this T entity, bool value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetStartOffset<T>(this T entity, float value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetTreasuryAmount<T>(this T entity, int value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetUseExitLine<T>(this T entity, bool value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetVisibleExitLine<T>(this T entity, bool value)
            where T : NarrativeStateDescription
        {
        ...
        public static T SetWaitForTimelineToEnd<T>(this T entity, bool value)
            where T : NarrativeStateDescription
        {
